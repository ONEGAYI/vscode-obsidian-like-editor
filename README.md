...
npm run test:integration        # @vscode/test-electron 1.86.2 真宿主集成测试（71 例）
...
- 当前开发工作树回归：768 单元测试 + 75 集成用例（真实 1.86.2 宿主）通过；安装态与人工验收另见[验证清单](docs/specs/manual-verification.md)。
